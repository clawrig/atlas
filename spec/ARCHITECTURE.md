...
5. **Foundation for Other Plugins** — Provide project metadata that relay, beads, and other tools build on
...
Atlas provides data. It doesn't enforce workflows. Relay owns issue routing. Beads owns local issues. Atlas just answers: "What project is this? What do I know about it?"
